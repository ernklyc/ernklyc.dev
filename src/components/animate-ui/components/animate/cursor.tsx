...
type CursorProviderProps = Omit<CursorProviderPropsPrimitive, "children"> & CursorContainerPropsPrimitive;
...
function Cursor({ className, ...props }: CursorProps) {
  return (
    <CursorPrimitive asChild {...props}>
      <svg className={cn("size-6 text-white", className)} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40">
        <path
          fill="currentColor"
...
export { CursorProvider, Cursor, CursorFollow, type CursorProviderProps, type CursorProps, type CursorFollowProps };
