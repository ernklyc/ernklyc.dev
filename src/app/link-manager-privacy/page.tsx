        ...
        <GlassCard className="p-8 md:p-10">
          <div className="mb-8">
            ...
            <a
              ...
              className="inline-block mt-4 text-[#A9B7C4] hover:text-[#C7D2DA] transition-colors text-sm"
            >
              View on Play Store →
            </a>
          </div>
          ...
          <div className="prose prose-invert max-w-none space-y-6">
            ...
            <section className="mb-8">
              ...
              <h3 className="text-xl font-semibold mb-2 text-gray-100 mt-6">2.1. User Content</h3>
            ...
            <hr className="border-white/10 mb-8" />
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-white">3. DATA COLLECTION METHODS</h2>
              
              <h3 className="text-xl font-semibold mb-2 text-gray-100 mt-6">3.1. Direct Collection</h3>
              <ul className="list-disc list-inside space-y-2 text-gray-300 ml-4">
                <li>Information you enter while using the application</li>
                <li>Application settings and preferences</li>
              </ul>

              <h3 className="text-xl font-semibold mb-2 text-gray-100 mt-6">3.2. Automatic Collection</h3>
              <ul className="list-disc list-inside space-y-2 text-gray-300 ml-4">
            ...
            <hr className="border-white/10 mb-8" />
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-white">4. PURPOSE OF DATA USE</h2>
              
              <h3 className="text-xl font-semibold mb-2 text-gray-100 mt-6">4.1. Service Provision</h3>
              <ul className="list-disc list-inside space-y-2 text-gray-300 ml-4">
              ...
              <h3 className="text-xl font-semibold mb-2 text-gray-100 mt-6">4.2. Subscription Management</h3>
              <ul className="list-disc list-inside space-y-2 text-gray-300 ml-4">
              ...
              <h3 className="text-xl font-semibold mb-2 text-gray-100 mt-6">4.3. Application Improvement</h3>
              <ul className="list-disc list-inside space-y-2 text-gray-300 ml-4">
              ...
              <h3 className="text-xl font-semibold mb-2 text-gray-100 mt-6">4.4. Security</h3>
              <ul className="list-disc list-inside space-y-2 text-gray-300 ml-4">
            ...
            <section className="mb-8">
              ...
              <h3 className="text-xl font-semibold mb-2 text-gray-100 mt-6">5.1. Third-Party Service Providers</h3>
              <ul className="list-disc list-inside space-y-2 text-gray-300 ml-4">
              ...
              <h3 className="text-xl font-semibold mb-2 text-gray-100 mt-6">5.2. Legal Requirements</h3>
              <p className="text-gray-300 leading-relaxed">
            ...
            <section className="mb-8">
              ...
              <h3 className="text-xl font-semibold mb-2 text-gray-100 mt-6">6.1. Security Measures</h3>
              <ul className="list-disc list-inside space-y-2 text-gray-300 ml-4">
              ...
              <h3 className="text-xl font-semibold mb-2 text-gray-100 mt-6">6.2. Data Retention</h3>
              <ul className="list-disc list-inside space-y-2 text-gray-300 ml-4">
            ...
            <hr className="border-white/10 mb-8" />
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-white">7. DEVICE ID USAGE</h2>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-300 leading-relaxed mt-4">
                To exercise your rights, contact us at: <a href="mailto:privacy@linkmanager.app" className="text-[#A9B7C4] hover:text-[#C7D2DA] transition-colors">privacy@linkmanager.app</a>
              </p>
            </section>
            ...
            <hr className="border-white/10 mb-8" />
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-white">10. COOKIES AND SIMILAR TECHNOLOGIES</h2>
              <p className="text-gray-300 leading-relaxed">
            ...
            <hr className="border-white/10 mb-8" />
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-white">11. INTERNATIONAL DATA TRANSFER</h2>
              <p className="text-gray-300 leading-relaxed">
            ...
            <hr className="border-white/10 mb-8" />
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-white">12. POLICY CHANGES</h2>
              <ul className="list-disc list-inside space-y-2 text-gray-300 ml-4">
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside space-y-2 text-gray-300 ml-4">
                <li>Email: <a href="mailto:privacy@linkmanager.app" className="text-[#A9B7C4] hover:text-[#C7D2DA] transition-colors">privacy@linkmanager.app</a></li>
                <li>Play Store: <a href="https://play.google.com/store/apps/details?id=com.link.manager&hl=tr" target="_blank" rel="noopener noreferrer" className="text-[#A9B7C4] hover:text-[#C7D2DA] transition-colors">Link Manager</a></li>
              </ul>
            </section>

            <hr className="border-white/10 mb-8" />
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-white">14. CONSENT</h2>
              <p className="text-gray-300 leading-relaxed">
