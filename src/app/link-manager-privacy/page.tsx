          ...
          <div className="prose prose-invert max-w-none space-y-6">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-300 leading-relaxed mt-4">
                To exercise your rights, contact us at: <a href="mailto:privacy@linkmanager.app" className="text-[#FF4655] hover:text-[#FF6B7A] transition-colors">privacy@linkmanager.app</a>
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside space-y-2 text-gray-300 ml-4">
                <li>Email: <a href="mailto:privacy@linkmanager.app" className="text-[#FF4655] hover:text-[#FF6B7A] transition-colors">privacy@linkmanager.app</a></li>
